...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Validador autenticacao = new AutenticacaoValidador();
        Validador autorizacao = new AutorizacaoValidador();
        Validador dados = new DadosValidador();

        autenticacao
                .setProximo(autorizacao)
                .setProximo(dados);
        ...
        autenticacao.validar(requisicao);
    }
}
